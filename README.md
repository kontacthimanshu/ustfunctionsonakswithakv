...
#### 10. Create an Azure Key Vault (hereinafter called AKV)
...
#### 17. Get the client ID of the MI of kubelet (autocreated by AKS for your, you can choose to have pre-created MI for Kubelet as well)
